...
import { handleReferralCommissionAutopilot, pollReferralCommissionAutopilot, runReferralCommissionAutopilot } from "./referral-commission-autopilot.js";
...
export default {
  async fetch(request, env, ctx) {
    ...
    const referralCommissionAutopilotResponse = await handleReferralCommissionAutopilot(request, env); if (referralCommissionAutopilotResponse) return referralCommissionAutopilotResponse;
