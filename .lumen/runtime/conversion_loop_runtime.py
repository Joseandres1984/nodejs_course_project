...
PRODUCTS = [
    ...
    {"id": "MP-SOURCING-5", "slug": "supplier-shortlist-5", "name": "Supplier Shortlist 5", "price_usd": 15, "service_id": "SRV-SOURCING-EXPRESS"},
    {"id": "MP-BUYER-SIGNALS", "slug": "buyer-signal-scan", "name": "Buyer Signal Scan", "price_usd": 19, "service_id": "SRV-B2B-PROSPECTING"},
    {"id": "MP-EXPORT-PULSE", "slug": "export-market-pulse", "name": "Export Market Pulse", "price_usd": 25, "service_id": "SRV-EXPORT-SCOUT"},
]
...
def _base_url(state: Dict[str, Any]) -> str:
    ...
    return str(cfg.get("public_base_url") or "https://lumen-zero-public.joseandresceol1-jac.workers.dev").rstrip("/")
    ...
    for p in PRODUCTS:
        ...
        rows.append({
            **p,
            ...
            "intent_url": f"{public}/intent?{urlencode(track)}",
            "cta": "Ver oferta y comprar",
            "funnel": ["visit", "intent", "checkout", "settled", "repeat"],
        })
    return {
        "version": VERSION,
        "status": "active",
