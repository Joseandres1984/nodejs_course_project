...
def css() -> str:
    return """<style>.auto-strip{margin:0 0 12px;padding:17px;border:1px solid #22536a;border-radius:18px;background:linear-gradient(135deg,#071822,#0b2633 55%,#0a171f);color:#f5faff}.auto-head{display:flex;justify-content:space-between;gap:18px;align-items:flex-start}.auto-head small,header small{font-size:10px;letter-spacing:.16em;color:#9edcff}.auto-head h2{font-size:20px;margin:5px 0 4px;color:#f5faff!important}.auto-head p{margin:0;color:#d7e8f7;line-height:1.45}.auto-open{white-space:nowrap;background:#80cfff;color:#061018!important;padding:9px 12px;border-radius:999px;font-weight:800}.auto-stats{display:grid;grid-template-columns:repeat(4,1fr);gap:8px;margin-top:14px}.auto-stats>div,.stage-grid>div{border:1px solid #23495c;background:#0b1b24;border-radius:12px;padding:10px}.auto-stats small,.stage-grid small{display:block;color:#afc7da;font-size:9px}.auto-stats b,.stage-grid b{display:block;color:#80cfff;font-size:22px;margin-top:3px}.auto-stats span{display:block;color:#afc7da;font-size:9px}.auto-page{max-width:1180px;margin:auto;padding:22px}.back{color:#63c6ff;text-decoration:none}header{margin:20px 0;padding:22px;border:1px solid #22536a;border-radius:18px;background:#0a1b25;color:#f5faff}header h1{font-size:32px;margin:5px 0;color:#f5faff!important}header p{color:#d7e8f7}.stage-grid{display:grid;grid-template-columns:repeat(9,1fr);gap:7px;margin:12px 0 18px}.auto-page section{background:#0b1822;border:1px solid #1a3a4b;border-radius:16px;padding:16px;margin:12px 0;color:#f5faff}.auto-page section h2{color:#f5faff!important}.auto-row{display:flex;justify-content:space-between;gap:16px;padding:11px 0;border-bottom:1px solid #17303e}.auto-row:last-child{border-bottom:0}.auto-row b{color:#f5faff!important}.auto-row p{margin:5px 0;color:#d7e8f7;font-size:12px}.auto-row small{color:#afc7da}.auto-row>span{color:#80cfff;font-size:11px;white-space:nowrap}.auto-empty{padding:14px;color:#d7e8f7}@media(max-width:850px){.stage-grid{grid-template-columns:repeat(3,1fr)}.auto-stats{grid-template-columns:1fr 1fr}}@media(max-width:520px){.auto-head{flex-direction:column}.auto-open{width:100%;text-align:center;box-sizing:border-box}.auto-row{flex-direction:column}.stage-grid{grid-template-columns:repeat(3,1fr)}}</style>"""
