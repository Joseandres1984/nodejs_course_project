...
VERSION = "2.1-dedicated-revenue-cockpit"
...
def dedicated_revenue_cockpit(_=Depends(auth)):
    ...
    shell_css = """
<style id="lumen-revenue-cockpit-shell-v21">
:root{color-scheme:dark}*{box-sizing:border-box}body{margin:0;background:radial-gradient(circle at 12% -8%,#17384b 0,#061018 38%);color:#eef7fb;font-family:Inter,ui-sans-serif,system-ui,-apple-system}.rc-shell{max-width:1480px;margin:0 auto;padding:12px 18px 0}.rc-shellbar{display:flex;align-items:center;justify-content:space-between;gap:12px;border:1px solid #31536a;background:#071720;border-radius:14px;padding:10px 12px}.rc-shellbrand{font-size:11px;font-weight:950;letter-spacing:.16em;color:#d7ff64}.rc-shelllinks{display:flex;gap:8px;flex-wrap:wrap}.rc-shelllinks a{text-decoration:none;color:#bfeaff;border:1px solid #2d5063;border-radius:9px;padding:8px 10px;font-size:11px;font-weight:850}.rc-shelllinks a.primary{background:#d7ff64;color:#07100a;border-color:#d7ff64}@media(max-width:700px){.rc-shell{padding:9px 9px 0}.rc-shellbar{align-items:flex-start;flex-direction:column}.rc-shelllinks{width:100%}.rc-shelllinks a{flex:1;text-align:center}}
</style>
"""
    nav = """
<div class="rc-shell"><div class="rc-shellbar"><div class="rc-shellbrand">LUMEN · REVENUE COCKPIT 2.1</div><div class="rc-shelllinks"><a class="primary" href="/revenue-cockpit">Caja & Conversión</a><a href="/command-center">Command Center completo</a><a href="/services">Servicios</a><a href="/intelligence">Intelligence</a></div></div></div>
"""
    return HTMLResponse(
