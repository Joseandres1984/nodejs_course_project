...
VERSION = "1.3-intelligence-catalog"
...
print({"service_revenue_public": {"version": VERSION, "status": "active", "active_catalog_entries": len(ACTIVE_IDS), "inquiry_capture": True, "required_fields": ["email", "need"], "optional_fields": ["company", "name"], "landing_link": True, "intelligence_link": True, "binding_terms": False}}, flush=True)
